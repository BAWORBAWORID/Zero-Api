...
keymongodb = 'mongodb+srv://admin:admin@rest.fuffc49.mongodb.net/?retryWrites=true&w=majority' //example "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
servicesmtp = 'gmail'//Ada gmail ada sendinblue ikut masing2 limit gmail 500 limit send https://nodemailer.com/smtp/well-known/inblue 300 free. List service smtp : https://nodemailer.com/smtp/well-known/
sendemail = 'ffmodnsbvs@gmail.com' //Email SMTP
fromsendemail = 'ffmodnsbvs@gmail.com' // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = 'hahahshshshhw.com' // Password Email SMTP
domain = process.env.domain
//domain = 'api-alpis.fazza-fabianfab.repl.co'// domain website tanpa http or https
...
recaptcha_key_1 = '6LemMVApAAAAAFbrJVr_d1YW-HTDJpSjKHirFidL'
recaptcha_key_2 = '6LemMVApAAAAAANgHyBnf_G_edwUC2Ceab6BqSnY'
